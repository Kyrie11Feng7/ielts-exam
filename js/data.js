      ...
      tests: [
        ...
        },
        {
            ...
            sections: [
              {
                ...
                type: '表格填空',
                questions: [
                  { q: 'Tour name:', a: 'Coastal Adventure' },
                  { q: 'Duration:', a: '3 days' },
                  { q: 'Start date:', a: '12th June' },
                  { q: 'Number of people:', a: '4' },
                  { q: 'Hotel type:', a: 'seaview room' },
                  { q: 'Included meals:', a: 'breakfast only' },
                  { q: 'Special activity:', a: 'dolphin watching' },
                  { q: 'Total price:', a: '480' },
                  { q: 'Deposit:', a: '120' },
                  { q: 'Booking reference:', a: 'CA-7823' }
                ]
              },
              {
                part: 'Part 2',
                ...
                type: '选择题 + 地图标注',
                questions: [
                  { q: 'The museum was founded in', a: 'B. 1895 (B选项)' },
                  { q: 'The special exhibition is about', a: 'C. ancient civilizations (C选项)' },
                  { q: 'The museum cafe is located', a: 'A. on the second floor (A选项)' },
                  { q: 'Entrance hall position:', a: '地图标注 - main building center' },
                  { q: 'Gift shop position:', a: '地图标注 - left of entrance' }
                ]
              },
              {
                part: 'Part 3',
                context: '导师与两名学生讨论论文选题',
                type: '选择题 + 匹配题',
                questions: [
                  { q: 'The tutor suggests focusing on:', a: 'B. renewable energy policies (B选项)' },
                  { q: 'Sarah\'s concern about the topic is:', a: 'C. too much existing research (C选项)' },
                  { q: 'The recommended research method is:', a: 'A. case study approach (A选项)' },
                  { q: 'Literature review deadline:', a: 'F. end of next week' },
                  { q: 'Data collection method:', a: 'D. interviews with experts' }
                ]
              },
              {
                part: 'Part 4',
                context: '关于城市可持续发展的学术讲座',
                type: '笔记填空',
                questions: [
                  { q: 'By 2050, ___ of the world population will live in cities.', a: '68%' },
                  { q: 'Urban areas currently consume ___ of global energy.', a: '78%' },
                  { q: 'Green buildings can reduce energy use by up to', a: '50%' },
                  { q: 'Vertical farming saves ___ compared to traditional agriculture.', a: '95% of water' },
                  { q: 'Smart traffic systems reduce congestion by', a: '25%' },
                  { q: 'Urban green spaces improve residents\'', a: 'mental health' },
                  { q: 'The concept of "15-minute cities" means everything is within', a: 'a 15-minute walk or cycle' },
                  { q: 'Solar panels on rooftops can power up to', a: '40% of household needs' },
                  { q: 'Rainwater harvesting systems collect up to', a: '60% of roof runoff' },
                  { q: 'The key to sustainable cities is', a: 'integrated planning' }
                ]
              }
            ]
          },
          reading: {
            ...
            passages: [
              {
                title: 'Passage 1: The Rediscovery of the Coelacanth',
                difficulty: '中等',
                summary: '被认为已灭绝的鱼类腔棘鱼的重新发现',
                questions: [
                  { type: '判断题', q: 'The coelacanth was believed to have been extinct for 65 million years.', a: 'TRUE' },
                  { type: '判断题', q: 'The first living coelacanth was found by a professional biologist.', a: 'FALSE - 由博物馆工作人员发现' },
                  { type: '判断题', q: 'Coelacanths are found in shallow waters.', a: 'FALSE - 深水区域' },
                  { type: '填空题', q: 'The fish was caught off the coast of ____ in 1938.', a: 'South Africa' },
                  { type: '填空题', q: 'The scientist who identified it was ____.', a: 'Marjorie Courtenay-Latimer' },
                  { type: '填空题', q: 'A second population was discovered near ____.', a: 'the Comoros Islands' }
                ]
              },
              {
                title: 'Passage 2: The Science of Sleep',
                difficulty: '中偏难',
                summary: '睡眠科学最新研究及睡眠对健康的影响',
                questions: [
                  { type: '段落标题匹配', q: 'Paragraph A', a: 'iii. The stages of sleep' },
                  { type: '段落标题匹配', q: 'Paragraph B', a: 'vi. Sleep and memory consolidation' },
                  { type: '段落标题匹配', q: 'Paragraph C', a: 'viii. Consequences of sleep deprivation' },
                  { type: '选择题', q: 'REM sleep is important for:', a: 'B. emotional processing and creativity' },
                  { type: '选择题', q: 'Chronic sleep loss is linked to:', a: 'D. cardiovascular disease and obesity' },
                  { type: '填空题', q: 'Adults need approximately ___ hours of sleep per night.', a: '7-9' }
                ]
              },
              {
                title: 'Passage 3: The Future of Work',
                difficulty: '难',
                summary: '技术变革对未来工作模式的影响',
                questions: [
                  { type: 'Yes/No/Not Given', q: 'Remote work will completely replace office work.', a: 'NO - 混合模式更可能' },
                  { type: 'Yes/No/Not Given', q: 'The gig economy benefits all workers equally.', a: 'NO - 存在不平等问题' },
                  { type: '选择题', q: 'The writer argues that automation will:', a: 'C. eliminate some jobs but create new ones' },
                  { type: '选择题', q: 'The main challenge for future workers is:', a: 'A. continuous reskilling' },
                  { type: '摘要填空', q: 'The future workplace requires ____ and ___.', a: 'adaptability / lifelong learning' }
                ]
              }
            ]
          },
            ...
            tasks: [
              {
                task: 'Task 1 (小作文)',
                type: '图表描述 - 柱状图',
                prompt: 'The bar chart below shows the percentage of people in different age groups who used social media platforms in a particular country in 2010 and 2020. Summarise the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words.',
                modelAnswer: 'The bar chart compares the proportions of social media users across five age groups in a specific country between the years 2010 and 2020.\n\nOverall, social media usage increased significantly across all age groups over the decade, with the most dramatic rise occurring among older users. In both years, younger people maintained the highest usage rates.\n\nIn 2010, approximately 85% of those aged 18-24 used social media, and this figure rose slightly to about 95% by 2020. Similarly, the 25-34 age group saw an increase from around 78% to 90%. The 35-44 age bracket experienced a more notable growth, climbing from roughly 60% to 82%.\n\nThe most striking changes were observed in the older age groups. Among those aged 45-54, usage more than doubled from approximately 35% to 75%. Perhaps most impressively, social media adoption among the 55+ age group surged from about 15% to 60%, representing a fourfold increase.\n\nThe data reveals that while young people were already heavy users of social media in 2010, the following decade saw older generations embrace these platforms at an unprecedented rate.',
                tips: '注意比较两个年份、不同年龄组的对比、趋势总结'
              },
              {
                task: 'Task 2 (大作文)',
                type: '议论文',
                prompt: 'In many countries, the amount of crime is increasing. What do you think are the main causes of crime? How can we deal with those causes? Write at least 250 words.',
                modelAnswer: 'The rise in crime rates is a pressing concern in numerous countries worldwide. This essay will examine the primary factors contributing to this trend and propose potential solutions to address them.\n\nOne of the main causes of increasing crime is economic inequality. When there is a significant gap between the wealthy and the poor, those living in poverty may turn to crime as a means of survival. Unemployment and lack of education further exacerbate this problem, as individuals without stable incomes or qualifications may see no legitimate path to financial security. Additionally, the breakdown of family structures and community bonds has left many young people without positive role models or support systems, making them more susceptible to criminal influences.\n\nAnother contributing factor is the proliferation of drugs and substance abuse. Drug addiction not only leads to drug-related crimes but also drives individuals to commit theft and other offences to finance their habits. Furthermore, inadequate law enforcement and lenient judicial systems in some regions fail to deter potential offenders.\n\nTo address these root causes, governments should prioritise economic development and job creation, particularly in disadvantaged areas. Investing in education and vocational training programmes can equip people with the skills needed to secure legitimate employment. Social welfare systems should be strengthened to provide a safety net for the most vulnerable members of society.\n\nAdditionally, community-based programmes that engage at-risk youth can provide alternatives to criminal activity. Mentorship schemes, after-school programmes, and sports clubs can help build positive relationships and a sense of belonging. For substance abuse issues, increased funding for rehabilitation centres and drug awareness programmes is essential.\n\nIn conclusion, while the causes of rising crime are complex and multifaceted, they are not insurmountable. By addressing economic inequality, improving education, strengthening communities, and providing effective rehabilitation, societies can work toward reducing crime rates and creating safer environments for all citizens.',
                tips: '注意问题要求（原因+解决方案）、逻辑连贯、举例支撑'
              }
            ]
          },
          speaking: {
            ...
            parts: [
              {
                part: 'Part 1: Introduction & Interview',
                questions: [
                  { q: 'Do you like cooking? Why/why not?', a: '参考回答: Yes, I enjoy cooking, though I wouldn\'t say I\'m an expert. I find it quite relaxing after a long day at work. There\'s something satisfying about preparing a meal from scratch and then sharing it with family or friends.' },
                  { q: 'What was the last meal you cooked?', a: '参考回答: Last weekend, I made a traditional Chinese dish called mapo tofu. It\'s a spicy Sichuan dish that I grew up eating. I followed my mother\'s recipe, and it turned out pretty well, though not quite as good as hers!' },
                  { q: 'Do you prefer eating at home or eating out?', a: '参考回答: It depends on the occasion. For everyday meals, I prefer cooking at home because it\'s healthier and more economical. But for special occasions or when I want to try different cuisines, eating out is definitely more enjoyable.' }
                ]
              },
              {
                part: 'Part 2: Long Turn (Cue Card)',
                cueCard: 'Describe a time when you received good news.\n\nYou should say:\n- what the news was\n- when you received it\n- who told you\n- and explain why it was good news.',
                modelAnswer: '参考回答:\n\nI\'d like to talk about a time when I received some wonderful news that I\'ll never forget. It was about two years ago when I was informed that I had been accepted into a master\'s degree programme at a university I\'d been dreaming of attending.\n\nI remember it was a Tuesday afternoon. I was at work, feeling quite nervous because I knew the admission results were supposed to be released that day. I kept checking my email on my phone but hadn\'t received anything. Then, around 3pm, my phone rang and it was a call from the university\'s admissions office.\n\nThe caller was a very polite woman from the admissions team who congratulated me and told me that my application had been successful. She explained that I\'d been offered a partial scholarship as well, which made the news even better.\n\nThis was incredibly good news for several reasons. Firstly, I had worked extremely hard for months preparing for the entrance exam and writing my personal statement. The acceptance felt like a validation of all that effort. Secondly, the scholarship would significantly reduce the financial burden on my family. And thirdly, studying at this particular university had been a goal of mine since I was in high school, so achieving it felt like a dream come true.\n\nI was so excited that I immediately called my parents to share the news. My mother actually cried with happiness. That evening, we went out for a celebration dinner, and it remains one of the happiest days of my life.',
                tips: '注意叙事时态（过去时）、情感表达、细节丰富'
              },
              {
                part: 'Part 3: Discussion',
                questions: [
                  { q: 'How do people usually share good news with others?', a: '参考回答: In today\'s digital age, people have many ways to share good news. Social media platforms like WeChat, Instagram, and Twitter have made it incredibly easy to broadcast news to a wide audience instantly. However, for more personal or significant news, many people still prefer face-to-face conversations or phone calls, as these methods feel more intimate and allow for a genuine emotional connection.' },
                  { q: 'Do you think the media focuses too much on bad news?', a: '参考回答: Yes, I think this is a real problem. The media tends to prioritise negative stories because they attract more attention and generate higher ratings. This can create a distorted view of the world, making people feel that things are worse than they actually are. While it\'s important to be informed about serious issues, I believe there should be more balance, with positive stories also being given prominence.' },
                  { q: 'Should schools teach children how to handle both success and failure?', a: '参考回答: Absolutely. I think this is one of the most important life skills that schools should teach. Many young people struggle with failure because they\'ve been shielded from it, and conversely, some don\'t know how to handle success gracefully without becoming arrogant. Schools should create an environment where both outcomes are treated as learning opportunities, helping students develop resilience and humility.' }
                ]
              }
            ]
          }
